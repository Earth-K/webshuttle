...
class CreateShuttleFrameService(CreateShuttleFrameUseCase):
    ...
    def create_shuttle_frame(self, shuttles, shuttle_seq, chrome_service, shuttle_widget_group, shuttles_widget,
                             time) -> ShuttleFrame:
        return ShuttleFrame(shuttles=shuttles,
                            shuttle_seq=shuttle_seq,
                            chrome_service=chrome_service,
                            shuttle_widget_group=shuttle_widget_group,
                            shuttles_widget=shuttles_widget, time=time)

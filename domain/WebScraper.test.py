...
class WebScraperTest(unittest.TestCase):
    def test_driver_execute_script(self):
        script = """
    ...
    def test_get_element_pos_x(self):
        script = """
    ...
    def test_get_element_pos_y(self):
        script = """
            let targetElement = document.getElementById('ws-tooltip');
    ...
    def test_get_element_class_names_of_target(self):
        ...
        mock.execute_script.assert_called_once_with(script)
        self.assertEqual(class_names_of_target, result)
    ...
    def test_get_elements_by_classnames(self):
        ...
        mock.execute_script.assert_called_once_with(script)
        self.assertEqual(class_names, result)

    def test_is_selected_elements(self):
        script = '''

...
def test_save_shuttles_to_json():
    ...
    shuttle_property = {"name": "Shuttle Name", "url": "https://google.com", "period": "300", "element_classes": "Target Class Names"}
    shuttles_properties = [shuttle_property]
    shuttles_widget_service.save_shuttles_to_json(shuttles_properties, JSON_FILE_NAME)
